...
def get_book_obj(csv_book):
    ...
    try:
        ...
        csv_book.Year = book_ranks.loc[:, 'Year'].tolist()
        csv_book.Rank = book_ranks.loc[:, 'Rank'].tolist()
        csv_book.Ratings = float(csv_book.Ratings)
        csv_book.Review = int(csv_book.Review)
    except Exception as e:
        print(e)
